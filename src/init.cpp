...
void Shutdown()
{
    ...
    RenameThread("hextechcoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/TripleHeXXX/HexTechCoin>";
    const std::string URL_WEBSITE = "<https://www.hextech.nz>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("hextechcoin-loadblk");
...
bool AppInitMain()
{
    ...
    if (gArgs.IsArgSet("-datadir") && !fs::path(gArgs.GetArg("-datadir", "")).is_absolute()) {
        LogPrintf("Warning: relative datadir option '%s' specified, which will be interpreted relative to the "
                  "current working directory '%s'. This is fragile, because if hextechcoin is started in the future "
                  "from a different location, it will be unable to locate the current data files. There could "
                  "also be data loss if hextechcoin is started while in a temporary directory.\n",
