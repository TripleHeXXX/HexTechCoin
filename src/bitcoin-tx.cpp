...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s hextechcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  hextechcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hextechcoin transaction") + "\n" +
              "  hextechcoin-tx [options] -create [commands]   " + _("Create hex-encoded hextechcoin transaction") + "\n" +
              "\n";
