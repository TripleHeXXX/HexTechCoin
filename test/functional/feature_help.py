...
"""Verify that starting hextechcoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start hextechcoin with -h for help text")
        ...
        self.log.info("Start hextechcoin with -version for version information")
